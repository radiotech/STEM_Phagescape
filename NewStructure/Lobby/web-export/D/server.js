...
var game = [{}];
game[0].setup = function(w){var g = game[0];
	w.level = 0;
...
game[0].exitRoom = function(player,w){var g = game[0];
	...
	var dimensionOffset = {"x":0,"y":0};
	var dimensionOffset2 = {"x":0,"y":0};
	if(w.level == 0){
...
game[0].getLobbyId = function(dim,wing,hall,room){
	if(wing > -1){dim+=wing*100+100;}
	if(hall > -1){dim+=hall*700+700+room*9800;}
	return dim;
}
...
function addGeneralBlock(w,i,col,solid,hard){checkArgs(arguments);
...
function outWorldProp(w){checkArgs(arguments);
	var updates = "PROPS:";	
...
function update(w){
	w.entities.forEach(function(mob) {
		...
		if(mob.changes.any){mob.changes.any = false;
			if(mob.changes.die){mob.changes.die = false;
...
function genBox(w, x, y, wi, h, weight, b){checkArgs(arguments);
...
function genLine(w, x1, y1, x2, y2, weight, b){checkArgs(arguments);
...
function genRing(w, x, y, wi, h, weight, b){checkArgs(arguments);
...
function genCircle(w,x,y,r,b){checkArgs(arguments);
	for(var i = 0; i < w.wSize; i++){
...
function genRoundRect(w,x,y,wi,h,rounding,b){checkArgs(arguments);
	x = Math.round(x); y = Math.round(y); wi = Math.round(wi); h = Math.round(h); rounding = Math.round(rounding);
...
function genRandomProb(w,from,to,prob){checkArgs(arguments);
	var totProb = 0;
	var tRand;
	var k;
...
function genFlood(w,x,y,b){checkArgs(arguments);
	if(x >= 0 && y >= 0 && x < w.wSize && y < w.wSize){
		var tB = aGS(w.wU,x,y);
		if(tB != b){
			aSS(w.wU,x,y,b);	
			if(aGS(w.wU,x+1,y) == tB){genFlood(w, x+1,y,b);}
			if(aGS(w.wU,x-1,y) == tB){genFlood(w, x-1,y,b);}
			if(aGS(w.wU,x,y+1) == tB){genFlood(w, x,y+1,b);}
			if(aGS(w.wU,x,y-1) == tB){genFlood(w, x,y-1,b);}
		}
	}
}
function genReplace(w,from, to){checkArgs(arguments);
	for(var i = 0; i < w.wSize; i++){
		for(var j = 0; j < w.wSize; j++){
			if(w.wU[i][j] == from){
				w.wU[i][j] = to;
...
function genTestPathExists(w,x1,y1,x2,y2){checkArgs(arguments);
	var nmap = [];
	for(var i = 0; i < w.wSize; i++){
		nmap[i] = []; fillArray(nmap[i],w.wSize,0);
	}
	return genTestPathExistsLoop(w,nmap, Math.floor(x1), Math.floor(y1), Math.floor(x2), Math.floor(y2));
}
function genTestPathExistsLoop(w,nmap,x,y,x2,y2){checkArgs(arguments);
	if(x >= 0 && y >= 0 && x < w.wSize && y < w.wSize){
			if(aGS(nmap,x,y) === 0){
				...
				aSS(nmap,x,y,1);	
				var bools = false;
				if(aGS1DB(w.gb.isSolid,aGS(w.wU,x+1,y)) === false){if(genTestPathExistsLoop(w,nmap, x+1,y,x2,y2)){bools=true;}}
				if(aGS1DB(w.gb.isSolid,aGS(w.wU,x-1,y)) === false){if(genTestPathExistsLoop(w,nmap, x-1,y,x2,y2)){bools=true;}}
				if(aGS1DB(w.gb.isSolid,aGS(w.wU,x,y+1)) === false){if(genTestPathExistsLoop(w,nmap, x,y+1,x2,y2)){bools=true;}}
				if(aGS1DB(w.gb.isSolid,aGS(w.wU,x,y-1)) === false){if(genTestPathExistsLoop(w,nmap, x,y-1,x2,y2)){bools=true;}}
				return bools;
			}
	}
...
function genLoadMap(w,thisMap){checkArgs(arguments);
	var pointer = 0;
	try{
...
mapLobbyDimension[0] = [[99,3543],[1,4],[19,1],[18,4],[19,1],[1,4],[99,85],[1,1],[15,4],[0,6],[15,4],[1,1],[99,83],[19,1],[15,5],[0,6],[15,5],[19,1],[99,81],[18,1],[0,2],[15,4],[0,6],[15,4],[0,2],[18,1],[99,79],[18,1],[0,3],[15,5],[0,4],[15,5],[0,3],[18,1],[99,77],[18,1],[0,5],[15,4],[0,4],[15,4],[0,5],[18,1],[99,75],[19,1],[0,7],[15,3],[0,4],[15,3],[0,7],[19,1],[99,73],[1,1],[15,1],[0,7],[15,3],[0,4],[15,3],[0,7],[15,1],[1,1],[99,71],[1,1],[15,4],[0,6],[15,1],[0,6],[15,1],[0,6],[15,4],[1,1],[99,70],[1,1],[15,5],[0,18],[15,5],[1,1],[99,70],[1,1],[15,7],[0,6],[15,2],[0,6],[15,7],[1,1],[99,70],[1,1],[15,8],[0,3],[15,6],[0,3],[15,8],[1,1],[99,70],[19,1],[0,3],[15,4],[0,3],[15,2],[20,4],[15,2],[0,3],[15,4],[0,3],[19,1],[99,70],[18,1],[0,10],[15,1],[20,6],[15,1],[0,10],[18,1],[99,70],[18,1],[0,9],[15,2],[20,6],[15,2],[0,9],[18,1],[99,70],[18,1],[0,9],[15,2],[20,6],[15,2],[0,9],[18,1],[99,70],[18,1],[0,10],[15,1],[20,6],[15,1],[0,10],[18,1],[99,70],[19,1],[0,3],[15,4],[0,3],[15,2],[20,4],[15,2],[0,3],[15,4],[0,3],[19,1],[99,70],[1,1],[15,8],[0,3],[15,6],[0,3],[15,8],[1,1],[99,70],[1,1],[15,7],[0,6],[15,2],[0,6],[15,7],[1,1],[99,70],[1,1],[15,5],[0,18],[15,5],[1,1],[99,70],[1,1],[15,4],[0,6],[15,1],[0,6],[15,1],[0,6],[15,4],[1,1],[99,71],[1,1],[15,1],[0,7],[15,3],[0,4],[15,3],[0,7],[15,1],[1,1],[99,73],[19,1],[0,7],[15,3],[0,4],[15,3],[0,7],[19,1],[99,75],[18,1],[0,5],[15,4],[0,4],[15,4],[0,5],[18,1],[99,77],[18,1],[0,3],[15,5],[0,4],[15,5],[0,3],[18,1],[99,79],[18,1],[0,2],[15,4],[0,6],[15,4],[0,2],[18,1],[99,81],[19,1],[15,5],[0,6],[15,5],[19,1],[99,83],[1,1],[15,4],[0,6],[15,4],[1,1],[99,85],[1,4],[19,1],[18,4],[19,1],[1,4],[99,3543]];

mapLobbyHall[0] = [[99,1841],[1,4],[19,1],[18,4],[19,1],[1,4],[99,85],[1,1],[15,4],[0,6],[15,4],[1,1],[99,84],[1,1],[15,3],[0,8],[15,3],[1,1],[99,84],[1,1],[15,2],[0,10],[15,2],[1,1],[99,84],[1,1],[15,1],[0,12],[15,1],[1,1],[99,84],[1,1],[15