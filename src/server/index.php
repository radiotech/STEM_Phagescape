<!DOCTYPE html>
	<head>
		...
		<title><?php
		$Game = "Lobby";
		if($_GET['G'] == 1){$Game = 'Game1';}
		if($_GET['G'] == 2){$Game = 'Game2';}
		if($_GET['G'] == 3){$Game = 'Game3';}
		if($_GET['G'] == 4){$Game = 'Game4';}
		if($_GET['G'] == 5){$Game = 'Game5';}
		if($_GET['G'] == 6){$Game = 'Game6';}
		echo $Game;
		?> : Built with Processing and Processing.js</title>
	...
	#content { 
		...
		<script src="data/D/aj.js" type="text/javascript"></script>
		<script type="text/javascript">
// convenience function to get the id attribute of generated sketch html element
function getProcessingSketchId () { return '<?php echo $Game ?>'; }
</script>
	...
	<body>
		<!--<div id="content">-->
			...
			<div>
				<center>
				<canvas id="<?php echo $Game ?>" data-processing-sources="<?php echo $Game ?>.pde" 
			...
			<h1><?php echo $Game ?></h1>
    		<p id="description"></p>
			<p id="sources">Source code: <a href="<?php echo $Game ?>.pde"><?php echo $Game ?></a> </p>
			<p>
